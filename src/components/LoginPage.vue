...
<template>
    <div class="bg-[url('/src/assets/AuthPages/AuthBackgroundSVG.png')] bg-cover bg-center bg-fixed min-h-screen">
        <RouterLink to="/">
    ...
    <div class="flex justify-center items-center min-h-screen p-2 sm:p-0">
            <div class="bg-radial-[at_-295%_-295%] from-white to-[] rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-8 pb-6 sm:pb-10 max-w-xs sm:max-w-sm w-full border border-gray-700">
                ...
                <form @submit="handleLogin" class="space-y-2 sm:space-y-4">
                    <div>
                    ...
                    <div class="m-auto">
                        <button type="submit" :disabled="loading" class="btn w-full px-4 sm:px-10 bg-green-600 hover:bg-green-700 text-white font-bold py-2 rounded-full transition duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 text-xs sm:text-base">
                ...
                <div class="flex items-center my-2 sm:my-4">
                    <div class="flex-grow h-px bg-gray-600"></div>
                    <span class="mx-2 sm:mx-3 text-gray-400 text-xs sm:text-sm font-medium">Or</span>
                    <div class="flex-grow h-px bg-gray-600"></div>
                </div>
                <div class="m-auto py-2 sm:py-3" data-onsuccess="onSignIn">
                    <button type="submit" class="btn w-full flex flex-row gap-2 sm:gap-3 justify-center bg-white hover:bg-green-700 text-black font-bold py-2 rounded-full transition duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 text-xs sm:text-base">
                        <img src="@/assets/3c6496fed241f7335a665be353150cd4.png" class="w-4 sm:w-5" alt="">
                        Sign In With Google
                    </button>
                </div>
            </div>
