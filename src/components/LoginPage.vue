...
<template>
    <div class="bg-[url('/src/assets/AuthPages/AuthBackgroundSVG.png')] bg-cover bg-center bg-fixed min-h-screen">
        <RouterLink to="/">
            <div class="fixed top-18 left-18 bg-white hover:bg-green-400 transition-all duration-300 rounded-full px-2 py-2.5">
                ...
                <form action="#" method="POST" class="space-y-4">
                    <div>
                        ...
                        <input type="email" name="email" id="email" autocomplete="email" required
                            class="w-full px-3 py-1.5 bg-gray-700 border border-gray-600 rounded focus:ring-green-500 focus:border-green-500 text-white placeholder-gray-400 text-sm"
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input id="terms" name="terms" type="checkbox" required
                                class="h-4 w-4 text-green-500 bg-gray-700 border-gray-600 rounded focus:ring-green-500">
                        </div>
                    ...
                    <div class="m-auto">
                        <button type="submit" class="w-full px-10 bg-green-600 hover:bg-green-700 text-white font-bold py-2.5 rounded-full transition duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 text-base">
                            Sign In
                        </button>
                    </div>
                </form>
